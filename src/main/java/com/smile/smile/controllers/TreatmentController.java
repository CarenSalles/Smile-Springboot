...
public class TreatmentController {
    ...
    @PutMapping(path = "/{idTreatment}")
    public ResponseEntity<?> update(@RequestBody TreatmentModel newTreatment,
            @PathVariable(value = "idTreatment") Long idTreatment) {

        TreatmentModel treatment = service.update(newTreatment, idTreatment);
